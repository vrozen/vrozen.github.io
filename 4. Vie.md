...
**Vie.**
Het ontwerpen van spellen is moeilijk en kost heel veel tijd. Om dit sneller en eenvoudiger te maken, hebben we de Vie app ontwikkeld [1, 2, 3]. Vie is een visuele programmeertaal waarmee je snel 2D spelletjes kunt ontwerpen.
...
A pre-release of Vie (v0.0.6) is available under the 2-clause BSD license.
