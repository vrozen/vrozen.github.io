...
permalink: /About/
menu: main
#My main goals, focus topics and impact areas are:
#* **Automated Game Design.** Accelerate game design processes by providing tools and techniques for #creating better games more quickly.
#* **Game-Based Learning.** Empower non-programmer experts, novices and children
#by combing play with tools and tutorials that bring code to life.
#* **Programming Languages.** Develop better programming languages by introducing input and feedback #mechanisms that enable live programming.
---
